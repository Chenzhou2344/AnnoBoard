...
"""
data_path = "http://localhost:7000//data/Prompts4dimensions/{}.txt"
...
jsonpath = "http://localhost:7000//data/annotation.json"
...
""" )
    ...
    for model in models:
        ...
        video_url = f"http:/localhost:7000/data/{model}/{subdirectory}/{video_name}"
